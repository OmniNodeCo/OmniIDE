...
hidden_imports = [
    ...
    "src.core.fuzzy", "src.core.quick_open", "src.core.project_search",
    "src.core.code_actions", "src.core.markdown", "src.core.textfile",
    ...
    "src.ui.quick_open", "src.ui.search_panel", "src.ui.minimap",
